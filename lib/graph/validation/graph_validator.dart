...
//   static GraphValidationResult
//       _validateGraphStructure<N extends $Node, E extends $Edge>(
//     Map<String, N> nodes,
//     Map<String, E> edges,
//   ) {
//     final errors = <String>[];
...
//         errors
//             .add('Edge ${edge.id}: sourceId "${edge.sourceId}" не существует');
//       }
//       if (!nodeIds.contains(edge.targetId)) {
//         errors
//             .add('Edge ${edge.id}: targetId "${edge.targetId}" не существует');
//       }
//     }
...
//   /// Валидирует contract
//   static GraphValidationResult _validateContract(
